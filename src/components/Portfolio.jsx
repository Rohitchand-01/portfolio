    ...
    <div id="work" className="mt-10 relative">
      <Div className="mb-10">
        ...
        <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-[#CCCCCC] text-center">
          Created innovative web solutions using React JS, Next JS, Node JS, MongoDB and Tailwind CSS enhancing
          user experience and functionality across various projects.
        </div>
      </Div>
        ...
        {projectData.map((item, index) => (
          <Div key={index} className="flex flex-col gap-4 cursor-pointer">
            <a
              ...
              className="block bg-black rounded-[20px] aspect-video overflow-hidden"
            >
              <img
                src={item.image}
                alt={item.name}
                className=" object-cover transition-transform duration-[2500ms] ease-linear hover:-translate-y-[15%]"
              />
            </a>
