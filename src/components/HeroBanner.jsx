  ...
  return (
    ...
    >
      ...
      <Wrapper>
        ...
        >
          <a
            onClick={() => window.open('mailto:rohitchand010904@gmail.com', '_blank')}
        ...
        >
          <div className='font-light mb-4'>
            👋 Hi, I Am <span className='font-semibold'>Rohit Chand</span>
          </div>
          <div className='max-w-[510px]'>
            Innovative web developer with a passion for creating dynamic,
            user-friendly websites and applications using modern technologies
            and best practices.
          </div>
        </motion.div>
        <motion.div
